function [U_final, Z_final, A_final, nIter_final, obj_all] = RNMF(X, Y, r, k, S, W, options, U, Z, A)
...
switch lower(options.Optimization)
    case {lower('Multiplicative')} 
        [U_final, Z_final, A_final, nIter_final, obj_all] = RNMF_Multi(X, Y, r, k, S, W, options, U, Z, A);
    otherwise
